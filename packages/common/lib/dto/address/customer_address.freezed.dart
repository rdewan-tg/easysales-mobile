...
class _CustomerAddress implements CustomerAddress {
   _CustomerAddress({required this.id, required this.customerId, this.deliveryName, this.address, this.salesPersonId, this.latitude = 0.0, this.longitude = 0.0, this.postalAddress, this.location, this.isPrimary = false, required this.companyId, required this.companyCode});
