...
MerchandiserCustomerResponse merchandiserCustomerResponseFromJson(String str) => MerchandiserCustomerResponse.fromJson(json.decode(str));

String merchandiserCustomerResponseToJson(MerchandiserCustomerResponse data) => json.encode(data);
...
class MerchandiserCustomerResponse with _$MerchandiserCustomerResponse {
    const factory MerchandiserCustomerResponse({
        ...
        required int total,
        @JsonKey(name: "data")
        required List<MerchandiserCustomerDto> data,
    }) = _MerchandiserCustomerResponse;

    factory MerchandiserCustomerResponse.fromJson(Map<String, dynamic> json) => _$MerchandiserCustomerResponseFromJson(json);
}
...
class MerchandiserCustomerDto with _$MerchandiserCustomerDto {
    ...
    factory MerchandiserCustomerDto.fromJson(Map<String, dynamic> json) => _$MerchandiserCustomerDtoFromJson(json);
}
